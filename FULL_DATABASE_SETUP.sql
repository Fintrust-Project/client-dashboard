...
-- 8. Payment Splits Table (for commission sharing)
...
-- Users can view splits where they are beneficiary or own the parent payment
...
-- Users can insert splits for their own payments
