 ...
 * Shared component — used on the public landing page.
 */
const TickerTape = () => {
  return (
    <div className="tradingview-widget-container" style={{ width: '100%', height: '78px' }}>
      ...
      <div className="tradingview-widget-copyright">
        <a
          href="https://www.tradingview.com/?utm_source=www.indiainvestkaro.com&amp;utm_medium=widget_new&amp;utm_campaign=ticker-tape"
          rel="noopener"
          target="_blank"
        >
